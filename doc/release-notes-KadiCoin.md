KadiCoin Core version *0.15.1* is now available from:

  <https://download.KadiCoin.org/KadiCoin-0.15.1/>
...
A number of changes to the way KadiCoin Core deals with peer connections and invalid blocks
