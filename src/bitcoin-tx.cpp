...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s KadiCoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  KadiCoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded KadiCoin transaction") + "\n" +
              "  KadiCoin-tx [options] -create [commands]   " + _("Create hex-encoded KadiCoin transaction") + "\n" +
              "\n";
