...
{
    const char* pszTimestamp = "2018-02-27 Kadikoy, Turkiye'de bulusan arkadaslar KadiCoin'i cikarirlar";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1519754827, 2084524493, 0x1e0ffff0, 1, 50 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x63c3eba3a4d4ac4b5d9a8fe8245c1a4c0066f985706efe815927ced6b345b4ed"));
        assert(genesis.hashMerkleRoot == uint256S("0x81c12af942ec977d1668c72130ce94d26947715a314ab093a92075aedef930c8"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        // vSeeds.emplace_back("seed-a.KadiCoin.loshan.co.uk", true);
        // vSeeds.emplace_back("dnsseed.thrasher.io", true);
        // vSeeds.emplace_back("dnsseed.KadiCointools.com", true);
        // vSeeds.emplace_back("dnsseed.KadiCoinpool.org", true);
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1519754827, 293345, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x86c0de61170d68673e1431d21d3312cc74cbb70b034ebfe98f021183c95df642"));
        assert(genesis.hashMerkleRoot == uint256S("0x81c12af942ec977d1668c72130ce94d26947715a314ab093a92075aedef930c8"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        // vSeeds.emplace_back("testnet-seed.KadiCointools.com", true);
        // vSeeds.emplace_back("seed-b.KadiCoin.loshan.co.uk", true);
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1519754827, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x5e39222ce064e1c9b70c6ae37d0914a1f87b995483190467658ca970d93c8347"));
        assert(genesis.hashMerkleRoot == uint256S("0x81c12af942ec977d1668c72130ce94d26947715a314ab093a92075aedef930c8"));
