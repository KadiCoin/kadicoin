...
#if defined(NDEBUG)
# error "KadiCoin cannot be compiled without assertions."
#endif
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    if (fRegTest) {
      ...
      switch (nHeight) {
        ...
        case 0: nSubsidy = 50 * COIN; break;
        case 1: nSubsidy = 90 * MAX_MONEY / 100; break;
        default: nSubsidy = CENT; break;
      }
    }
    else if (fTestNet) {
      ...
      switch (nHeight) {
        ...
        case 0: nSubsidy = 50 * COIN; break;
        case 1: nSubsidy = 30 * MAX_MONEY / 100; break;
        default: nSubsidy = COIN; break;
      }
    }
    else {
